    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if(op==4){
                ...
                System.out.println("\n--------------------Tabla de datos Jubilados  por Discapacidad----------------\n");
                System.out.println("CEDULA|NOM. Y APELL. |A.APORTE |P.INICIAL|%DE DISC|P.FINAL");
               ...
               //----------------------------------------------------------
                System.out.println("\n----------------Tabla de datos Jubilados por Vejez-------------------------\n");
                System.out.println("CEDULA  |NOM. Y APELL.|A.APORTE |P.INICIAL|P.FINAL");
                for (Jubilado jub : jubilados) {
                    jub.calculaPensioni();
                    jub.calcularPension();
                ...
                //-------------------------------------------------------------
                System.out.println("\n ---------------Tabla de datos Jubilados tipo Patronal-----------------------\n");
                System.out.println("CEDULA |NOM. Y APELL. |A.APOR |P.INI|<1.PUB> O<2.PRI>|P.FINAL");
                for (Jubilado jub : jubilados) {
                    jub.calculaPensioni();
                    jub.calcularPension();
